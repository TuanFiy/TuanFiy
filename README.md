...
**1. Bowling Fitness Tracker (Web Application)**
* A performance monitoring system specifically designed for bowlers to track scores and fitness metrics.
* **Tech:** MERN Stack (MongoDB, Express, React, Node.js).
* *Note: Previously built with ASP.NET, currently refactoring specifically to master JavaScript backend architecture.*
